					...
					<div class="col-md-12">
						...
						<div class="widget">
							...
							<div>
								...
								<label><input type="checkbox" class="toggle-vis" data-column="3" checked="checked"> Designation</label>
								<label><input type="checkbox" class="toggle-vis" data-column="4" checked="checked"> Department</label>
								<label><input type="checkbox" class="toggle-vis" data-column="5" checked="checked"> Gross Salary</label>
								<label><input type="checkbox" class="toggle-vis" data-column="6" checked="checked"> Basic Salary</label>
								<label><input type="checkbox" class="toggle-vis" data-column="7" checked="checked"> Bank Account No</label>
								<label><input type="checkbox" class="toggle-vis" data-column="8" checked="checked"> Working Hours</label>
								<label><input type="checkbox" class="toggle-vis" data-column="9" checked="checked"> Remarks</label>
								<label><input type="checkbox" class="toggle-vis" data-column="10" checked="checked"> Action</label>
							</div>
