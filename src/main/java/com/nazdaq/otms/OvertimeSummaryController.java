...
import com.nazdaq.otms.bean.OvertimeDtlBean;
import com.nazdaq.otms.bean.OvertimeSheet;
import com.nazdaq.otms.model.Department;
import com.nazdaq.otms.model.OvertimeDtl;
...
public class OvertimeSummaryController {
	...
	public ModelAndView generateOtSummary(@ModelAttribute("overtimeSummaryForm") OvertimeSummary overtimeSummaryBean,
			BindingResult result, Principal principal, RedirectAttributes attributes) throws Exception {
		...
		List<OvertimeSummary> otSummaryList = (List<OvertimeSummary>) (Object) commonService
				.getObjectListByTwoColumn("OvertimeSummary", "otYear", otYear, "otMonth", otMonth);

		if (otSummaryList != null && otSummaryList.size() > 0) {
			OvertimeSummary otd = otSummaryList.get(0);
			if (otd.getFinalSubmit() == 1) {
				return this.otSummaryFinalList(overtimeSummaryBean, principal);
			} else {
			...
			if (maxId > 0) {
				...
				if (res) {
					this.saveNewOtSummary(otYear, otMonth, loginUser);
	...
	public ModelAndView otSummaryFinalList(OvertimeSummary overtimeSummary, Principal principal) throws ParseException {
	...
	private @ResponseBody String getMonthlyOtSummaryList(@RequestBody String jesonString, Principal principal)
		...
		List<OvertimeSummary> otSummaryList = (List<OvertimeSummary>) (Object) commonService.getObjectListByTwoColumn(
				"OvertimeSummary", "otYear", otSummaryBean.getOtYear(), "otMonth", otSummaryBean.getOtMonth());

		List<OvertimeDtl> otDtlailsList = (List<OvertimeDtl>) (Object) commonService.getObjectListByTwoColumn(
				"OvertimeDtl", "otYear", otSummaryBean.getOtYear(), "otMonth", otSummaryBean.getOtMonth());

		List<OvertimeDtl> otDtlailsList1 = (List<OvertimeDtl>) (Object) commonService
				.getObjectListByTwoColumn("OvertimeDtl", "otYear", year1.toString(), "otMonth", prevOneMonth);

		List<OvertimeDtl> otDtlailsList2 = (List<OvertimeDtl>) (Object) commonService
				.getObjectListByTwoColumn("OvertimeDtl", "otYear", year2.toString(), "otMonth", prevTwoMonth);

		List<OvertimeDtl> otDtlailsList3 = (List<OvertimeDtl>) (Object) commonService
				.getObjectListByTwoColumn("OvertimeDtl", "otYear", year3.toString(), "otMonth", prevThreeMonth);
	...
	private @ResponseBody String saveMonthlyOtSummaryList(@RequestBody String jesonString, Principal principal)
			throws JsonGenerationException, JsonMappingException, Exception {
		String toJson = "";
		String result = "";
		Gson gson = new Gson();
		...
		List<OvertimeSummary> otSummaryListDb = (List<OvertimeSummary>) (Object) commonService.getObjectListByTwoColumn(
				"OvertimeSummary", "otYear", otSummaryBean.getOtYear(), "otMonth", otSummaryBean.getOtMonth());
	...
	public ModelAndView otSummaryFinalSubmit(OvertimeSummary otSummary, Principal principal,
		...
		// model);
		return this.otSummaryFinalList(otSummary, principal);
	}

	@SuppressWarnings("unchecked")
	private void saveNewOtSummary(String otYear, String otMonth, String loginUser) {
